  ...
  return (
    <div className="recipe-edit">
      ...
      <div className="recipe-edit__details-grid">
        ...
        <textarea name="instructions" id="instructions" className="recipe-edit__input" onChange={e => handleChange({ instructions: e.target.value })} value={recipe.instructions}> </textarea>
      </div>
      <br/>
